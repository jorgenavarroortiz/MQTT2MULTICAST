...
from . import vxlan
from . import geneve
from . import mqtt2multicast # JNa: for MQTT2MULTICAST
...
class udp(packet_base.PacketBase):
    ...
    def get_packet_type(src_port, dst_port):
        ...
        if ((dst_port == mqtt2multicast.UDP_SERVER_PORT) or 
           (dst_port == mqtt2multicast.UDP_CLIENT_PORT)):
            return mqtt2multicast.mqtt2multicast
        return None
